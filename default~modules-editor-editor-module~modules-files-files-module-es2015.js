...
/* harmony import */ var _constants_storage_keys__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../constants/storage-keys */ "./src/app/constants/storage-keys.ts");
...
/* harmony import */ var _local_forage_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./local-forage.service */ "./src/app/services/local-forage.service.ts");
...
class FileService {
    constructor(localForage) {
        ...
        this.files$.subscribe((files) => this.localForage.setItem(_constants_storage_keys__WEBPACK_IMPORTED_MODULE_4__["StorageKeys"].FILES, files));
        localForage.get(_constants_storage_keys__WEBPACK_IMPORTED_MODULE_4__["StorageKeys"].FILES).then((files) => {
            if (files) {
    ...
    get(id) {
        return this.files$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((files) => files[id]));
    }
    /**
     * Creates the given file
     */
    create(file) {
        const id = shortid__WEBPACK_IMPORTED_MODULE_3___default()();
        return this.files$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((files) => (Object.assign(Object.assign({}, files), { [id]: Object.assign(Object.assign({}, file), { id }) }))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((files) => this.files$.next(files)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(() => this.get(id)));
    }
    /**
     * Updates the given file
     */
    update(file) {
        return this.files$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((files) => (Object.assign(Object.assign({}, files), { [file.id]: file }))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((files) => this.files$.next(files)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(() => this.get(file.id)));
    }
    /**
     * Removes the file from localStorage
     */
    remove(id) {
        return this.files$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((files) => {
            delete files[id];
            return files;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((files) => this.files$.next(files)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(() => this.get(id)));
    }
    /**
     * Removes all fields
     */
    removeAll() {
        this.files$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(() => this.files$.next({})));
    }
    /**
    ...
    searchFiles$(params) {
        ...
        return this.files$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Object.values), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((files) => {
            const fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_5__["default"](files, {
                sortFn: orderBy
    ...
    removeMultiple(ids) {
        this.files$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((files) => {
...
FileService.ɵfac = function FileService_Factory(t) { return new (t || FileService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_local_forage_service__WEBPACK_IMPORTED_MODULE_6__["LocalForageService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FileService, [{
    ...
    }], function () { return [{ type: _local_forage_service__WEBPACK_IMPORTED_MODULE_6__["LocalForageService"] }]; }, null); })();


/***/ })

}]);
//# sourceMappingURL=default~modules-editor-editor-module~modules-files-files-module-es2015.js.map